...
struct process
{
	...
	unsigned char priority;		// priority = rt_priority + nice
	unsigned char rt_priority;	// (0 ~ 99) real-time process priority
	unsigned char nice;		// (0 ~ 40) original process priority
	unsigned time_slice;	
